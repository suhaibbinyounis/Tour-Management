    ...
    <div class="register-photo">
        <div class="form-container">
            <form method="post" style="text-align: center;width: 900px;" action="RouteDetails.php">
                ...
                <div class="form-group"><p><strong>What support would be given by Tour Management?</strong></p>
                	<p><ol><li>Operational Support through business and program management teams</li>
<li>Marketing support to conduct local activities</li>
<li>Guidelines for recruitment</li>
<li>Training and Development Support</li>
<li>Store Launch</li>
<li>Special products and offers on need</li>
<li>Technological support</li></ol></p></div>
                </form>
        </div>
    </div>
